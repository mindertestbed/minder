...
public class RestUtilClassController extends Controller {
    ...
    public static Result addUtilClass() {
    ...
    public static Result editUtilClass() {
        RestMinderResponse minderResponse = new RestMinderResponse();
    ...
    public static Result deleteUtilClass() {
        RestMinderResponse minderResponse = new RestMinderResponse();
    ...
    private static void checkAndAssignRequiredFields(UtilClass uc, RestUtilClass restUtilClass) throws IllegalArgumentException {
