...
public class RestTestAssertionController extends Controller {
   ...
   */
  public Result listTestAssertions() {
   ...
   */
  public Result getTestAssertion() {
  ...
  public Result addTestAssertion() {
  ...
  public Result editTestAssertion() {
    RestMinderResponse minderResponse = new RestMinderResponse();
  ...
  public Result deleteTestAssertion() {
    RestMinderResponse minderResponse = new RestMinderResponse();
  ...
  private void checkAndAssignRequiredFields(TestAssertion ta, RestTestAssertion restTestAssertion) throws IllegalArgumentException {
