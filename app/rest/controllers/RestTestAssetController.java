...
public class RestTestAssetController extends Controller {
  ...
  private void checkAndAssignRequiredFields(TestAsset ta, RestTestAsset restTestAsset) throws IllegalArgumentException {
  ...
  protected void handleFileUpload(TestAsset testAsset, byte[] asset) throws IOException, FileNotFoundException {
  ...
  protected byte[] handleFileDownload(TestAsset testAsset) throws IOException {
