...
public class RestTdlController extends Controller{
    ...
    private static void checkAndAssignRequiredFields(Tdl tdl, RestTdl restTdl) throws IllegalArgumentException {
