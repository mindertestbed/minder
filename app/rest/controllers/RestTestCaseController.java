...
public class RestTestCaseController extends Controller {
     ...
     */
    public static Result getTestCase() {
    ...
    public static Result addTestCase() {
    ...
    public static Result editTestCase() {
        RestMinderResponse minderResponse = new RestMinderResponse();
    ...
    public static Result deleteTestCase() {
        RestMinderResponse minderResponse = new RestMinderResponse();
    ...
    private static void checkAndAssignRequiredFields(TestCase tc, RestTestCase restTestCase) throws IllegalArgumentException {
