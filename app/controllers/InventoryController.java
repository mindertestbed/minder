...
public class InventoryController extends Controller {
  ...
  public static Result viewTestGroup(Long id) {
    TestGroup tg = TestGroup.findById(id);
    if (tg == null){
      return badRequest("No job with id " + id + ".");
    }
    return ok(testGroupView.render(tg, Application.getLocalUser(session())));
  }
  ...
  public static Result viewTestAssertion(Long id){
    TestAssertion ta = TestAssertion.findById(id);
    if (ta == null){
      return badRequest("No test assertion with id " + id + ".");
    }
    return ok(testAssertionView.render(ta, Application.getLocalUser(session())));
  }
